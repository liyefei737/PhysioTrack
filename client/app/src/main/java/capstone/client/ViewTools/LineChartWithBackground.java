...
public class LineChartWithBackground extends LineChart{
    ...
    public static void formatUpdateLineChart(Resources resources, LineChartWithBackground lineChart, List<Entry> entries, float yMin, float yMax, float [] zoneLimits){
        //get colours
