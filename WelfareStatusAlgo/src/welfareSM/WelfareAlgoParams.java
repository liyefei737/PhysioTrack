...
public class WelfareAlgoParams {
	...
	// min values to be considered valid. Lower than this, sensor is
	// malfunctioning, or user is dead.
	...
	public WelfareAlgoParams(List<Integer> heartRateRange, double heartWeight, List<Integer> breathRateRange,
			double breathWeight, List<Float> skinTempRange, double skinWeight, List<Float> coreTempRange,
			double coreWeight) {
	...
	public boolean setPhysioParamWeights(double heartWeight, double breathWeight, double skinWeight,
			double coreWeight) {
